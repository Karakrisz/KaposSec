        ...
        <div class="item">
            <div class="main-slider-one__item">
                ...
                <div class="main-slider-one__shape main-slider-one__shape--one">
                    <img src="assets/images/shapes/slider-shape-1-1.png" alt>
                </div>
                <div class="main-slider-one__shape main-slider-one__shape--two">
                    <img src="assets/images/shapes/slider-shape-1-2.png" alt>
                </div>
            </div>
        </div>
        <!-- Slider Item  -->
...
<section class="service-one" id="rolunk">
    <div class="container">
        <div class="row gutter-y-40">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-one__item wow fadeInUp" data-wow-delay="900ms">
                    <div class="service-one__item__icon">
            ...
            <div class="col-lg-6">
                <div class="about-one__left wow fadeInLeft" data-wow-delay="500ms">
                    ...
                    <div class="about-one__shape-two">
                        <img src="assets/images/shapes/about-shape-1-2.png" alt>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-one__right">
                    ...
                    <div class="about-one__feature">
                        <div class="about-one__feature__item wow fadeInUp" data-wow-delay="500ms">
                            <div class="about-one__feature__inner">
                                <div class="about-one__feature__item__icon">
                                    <div class="about-one__feature__item__icon__item">
                                        <i class="icon-nanotechnology-1"></i>
                                    </div>
                                </div>
...
<section class="why-choose-two">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="why-choose-two__funfact__item count-box wow fadeInUp" data-wow-delay="600ms">
                    <div class="why-choose-two__funfact__item__icon">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="why-choose-two__funfact__item count-box wow fadeInUp" data-wow-delay="900ms">
                    <div class="why-choose-two__funfact__item__icon">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="why-choose-two__funfact__item count-box wow fadeInUp" data-wow-delay="1100ms">
                    <div class="why-choose-two__funfact__item__icon">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="why-choose-two__top__left">
                        <div class="sec-title sec-title--two wow fadeInUp" data-wow-duration='1500ms'
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="why-choose-two__inner__left">
                        ...
                        <div class="why-choose-two__inner__item wow fadeInUp" data-wow-delay="600ms">
                            <div class="why-choose-two__inner__item__content">
                                <div class="why-choose-two__inner__item__icon">
...
<section class="testimonials-one">
    <div class="container">
        <div class="testimonials-one__carousel ostech-owl__carousel owl-theme owl-carousel" data-owl-options='{
			"items": 1,
			"margin": 10,
			"smartSpeed": 700,
			"loop":true,
            ...
            <div class="testimonials-one__item" data-hash="item1">
                <div class="testimonials-one__item__inner">
                    <div class="testimonials-one__item__bg"
                        style="background-image: url(assets/images/shapes/testimonial-1-1.png);"></div>
                    ...
                    <p class="testimonials-one__item__text">There are many variations of passages of Lorem Ipsum
                        available, but the majority have suffered alteration in some form, by injected humour, or
                        randomised words There are many variations of passages of Lorem Ipsum available, but the
                        majority</p>
                    <div class="testimonials-one__item__author">
                        <h5 class="testimonials-one__item__name">Theresa Webb</h5>
                        <p class="testimonials-one__item__deg">Customer</p>
                    </div>
                </div>
            </div>
            <div class="testimonials-one__item" data-hash="item2">
                <div class="testimonials-one__item__inner">
                    <div class="testimonials-one__item__bg"
                        style="background-image: url(assets/images/shapes/testimonial-1-1.png);"></div>
                    <div class="testimonials-one__item__quite">
            ...
            <div class="testimonials-one__item" data-hash="item3">
                <div class="testimonials-one__item__inner">
                    <div class="testimonials-one__item__bg"
                        style="background-image: url(assets/images/shapes/testimonial-1-1.png);"></div>
                    <div class="testimonials-one__item__quite">
        ...
        <div class="carousel-thumb__two">
            <!-- Testimonial Thumb -->
            <div class="testimonials-one__carousel-thumb ostech-owl__carousel owl-theme owl-carousel" data-owl-options='{
				"items": 3,
				"margin": 10,
				"smartSpeed": 700,
				"loop":true,
                ...
                <a href="#item1" class="item" data-hash="item1">
                    <span class="testimonials-one__meta-thumb"><img src="assets/images/resources/testi-1-4.jpg"
                            alt="ostech"></span>
                </a>
                <a href="#item2" class="item" data-hash="item2">
                    <span class="testimonials-one__meta-thumb"><img src="assets/images/resources/testi-1-3.jpg"
                            alt="ostech"></span>
                </a>
                <a href="#item3" class="item" data-hash="item3">
                    <span class="testimonials-one__meta-thumb"><img src="assets/images/resources/testi-1-6.jpg"
                            alt="ostech"></span>
                </a>
            </div>
            <!-- Testimonial Thumb -->
...
<section class="benefit-one">
    ...
    <div class="benefit-one__shape">
        <img src="assets/images/shapes/benefit-shape-1-1.png" alt>
    </div>
</section>
<!-- Benefit section End -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="sec-title text-center wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="assets/images/shapes/sec-title-s-1.png" alt="Article" class="sec-title__img">
        ...
        <div class="row gutter-y-30">
                ...
                <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                    ...
                    <div class="blog-card__content">
                        <ul class="list-unstyled blog-card__meta">
                            <li><a href="#"><img src="assets/images/blog/blog-author-1-1.jpg" alt="ostech"> Jane
                                    Cooper</a></li>
                            <li><a href="#"><i class="icon-bubble-chat-1"></i>2 Comments</a></li>
                        </ul>
                        <div class="blog-card__content__inner">
                            <h3 class="blog-card__title"><a href="blog-details-right.html">Improving Business
                                    Growth with New Technology</a></h3>
                            <a href="blog-details-right.html" class="blog-card__link">Read more<i
            ...
            <div class="col-md-6 col-lg-4">
                <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                    ...
                    <div class="blog-card__content">
                        <ul class="list-unstyled blog-card__meta">
                            <li><a href="#"><img src="assets/images/blog/blog-author-1-2.jpg" alt="ostech">
                                    Annette Black</a></li>
                            <li><a href="#"><i class="icon-bubble-chat-1"></i>2 Comments</a></li>
                        </ul>
                        <div class="blog-card__content__inner">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                    ...
                    <div class="blog-card__content">
                        <ul class="list-unstyled blog-card__meta">
                            <li><a href="#"><img src="assets/images/blog/blog-author-1-3.jpg" alt="ostech">
                                    Eleanor Pena</a></li>
                            <li><a href="#"><i class="icon-bubble-chat-1"></i>2 Comments</a></li>
                        </ul>
                        <div class="blog-card__content__inner">
...
<div class="client-carousel client-carousel-one ">
    <div class="container">
        <div class="client-carousel__one ostech-owl__carousel owl-theme owl-carousel" data-owl-options='{
            "items": 5,
            "margin": 55,
            "smartSpeed": 700,
            "loop":true,
...
<section class="cta-two">
    <div class="container">
        <div class="row gutter-y-30">
            <div class="col-lg-6">
                <div class="cta-two__item wow fadeInUp" data-wow-delay="300ms">
                    <div class="cta-two__item__icon">
            ...
            <div class="col-lg-6">
                <div class="cta-two__item wow fadeInUp" data-wow-delay="600ms">
                    <div class="cta-two__item__icon">
